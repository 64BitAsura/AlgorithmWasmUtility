(module
 ...
 (data (i32.const 1856) "\08\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 1884) "\02\t\00\00\00\00\00\00\02A\00\00\00\00\00\00$\t\00\00\00\00\00\00\01\t\00\00\02\00\00\00B")
      ...
      block $~lib/array/Array<~lib/array/Array<i32>>
       block $~lib/string/String
        block $~lib/arraybuffer/ArrayBuffer
         ...
         i32.sub
         i32.load
         br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner0 $folding-inner1 $~lib/array/Array<~lib/array/Array<i32>> $~lib/staticarray/StaticArray<i32> $folding-inner0 $folding-inner1 $invalid
        end
        return
       end
       return
 ...
 (func $~lib/staticarray/StaticArray<i32>#slice (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
